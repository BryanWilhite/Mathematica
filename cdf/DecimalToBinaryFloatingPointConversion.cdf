...
NotebookDataLength[     82960,       1682]
NotebookOptionsPosition[     56065,       1096]
NotebookOutlinePosition[     82338,       1657]
CellTagsIndexPosition[     82227,       1651]
WindowTitle->Decimal to Binary Floating-Point Conversion
WindowFrame->Normal*)
...
Cell["Decimal to Binary Floating-Point Conversion", "DemoTitle"],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`decval$$ = 54.75, $CellContext`expbit$$ = 
    3, $CellContext`mantbit$$ = 4, Typeset`show$$ = True, 
    Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
    Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
    "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`decval$$], 1, "base-10 number"}, 
      Dynamic[(-(2 - 2^(-$CellContext`mantbit$$))) 
       2^(2^$CellContext`expbit$$ - 1)], 
      Dynamic[(2 - 2^(-$CellContext`mantbit$$)) 
       2^(2^$CellContext`expbit$$ - 1)]}, {{
       Hold[$CellContext`expbit$$], 1, "bits in exponent"}, 1, 4, 1}, {{
       Hold[$CellContext`mantbit$$], 1, "bits in mantissa"}, 1, 6, 1}}, 
    Typeset`size$$ = {274., {41., 50.}}, Typeset`update$$ = 0, 
    Typeset`initDone$$, Typeset`skipInitDone$$ = 
    True, $CellContext`decval$2628$$ = 0, $CellContext`expbit$2629$$ = 
    0, $CellContext`mantbit$2630$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`decval$$ = 1, $CellContext`expbit$$ = 
        1, $CellContext`mantbit$$ = 1}, "ControllerVariables" :> {
        Hold[$CellContext`decval$$, $CellContext`decval$2628$$, 0], 
        Hold[$CellContext`expbit$$, $CellContext`expbit$2629$$, 0], 
        Hold[$CellContext`mantbit$$, $CellContext`mantbit$2630$$, 0]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        Typeset`animator$$, Typeset`animvar$$, Typeset`name$$, 
        Typeset`specs$$, Typeset`size$$, Typeset`update$$, Typeset`initDone$$,
         Typeset`skipInitDone$$}, "Body" :> 
      Module[{$CellContext`macheps$, $CellContext`sign$, \
$CellContext`expsign$, $CellContext`decnum$, $CellContext`expval$, \
$CellContext`mantval$, $CellContext`exp$, $CellContext`mant$, \
$CellContext`i$, $CellContext`exp1$, $CellContext`max$}, \
$CellContext`macheps$ = 2^(-$CellContext`mantbit$$); $CellContext`sign$ = 
         1 - UnitStep[$CellContext`decval$$]; $CellContext`decnum$ = 
         Abs[$CellContext`decval$$]; $CellContext`expsign$ = 
         1 - UnitStep[$CellContext`decnum$ - 1]; $CellContext`expval$ = Abs[
           Floor[
           Log[$CellContext`decnum$]/Log[
            2]]]; $CellContext`mantval$ = $CellContext`decnum$ 
           2^((2 $CellContext`expsign$ - 1) $CellContext`expval$) - 
          1; $CellContext`exp$ = 
         Range[$CellContext`expbit$$]; $CellContext`mant$ = 
         Range[$CellContext`mantbit$$]; 
        For[$CellContext`i$ = $CellContext`expbit$$, $CellContext`i$ > 0, 
          Decrement[$CellContext`i$], 
          
          If[$CellContext`expval$/2^($CellContext`i$ - 1) >= 1, 
           Part[$CellContext`exp$, $CellContext`expbit$$ - $CellContext`i$ + 
              1] = 1; $CellContext`expval$ = $CellContext`expval$ - 
             2^($CellContext`i$ - 1), 
           Part[$CellContext`exp$, $CellContext`expbit$$ - $CellContext`i$ + 
             1] = 0]]; 
        For[$CellContext`i$ = 1, $CellContext`i$ <= $CellContext`mantbit$$, 
          Increment[$CellContext`i$], 
          
          If[$CellContext`mantval$ 2^$CellContext`i$ >= 1, 
           Part[$CellContext`mant$, $CellContext`i$] = 
            1; $CellContext`mantval$ = $CellContext`mantval$ - 
             2^(-$CellContext`i$), Part[$CellContext`mant$, $CellContext`i$] = 
           0]]; $CellContext`exp$ = StringJoin[
           Map[ToString, $CellContext`exp$]]; $CellContext`mant$ = StringJoin[
           Map[ToString, $CellContext`mant$]]; $CellContext`max$ = (
           2 - $CellContext`macheps$) 2^(2^$CellContext`expbit$$ - 1); 
        If[Abs[$CellContext`decval$$] > $CellContext`max$, $CellContext`exp1$ = 
           "The base\[Hyphen]10 number is out of range."; $CellContext`sign$ = 
           0; $CellContext`expsign$ = 0; $CellContext`exp$ = ConstantArray[0, 
             Length[$CellContext`exp$]]; $CellContext`mant$ = ConstantArray[0, 
             Length[$CellContext`mant$]], $CellContext`exp1$ = " "]; Text[
          Style[
           Column[{$CellContext`exp1$, 
             
             Grid[{{"sign of\nnumber", "sign of\nexponent", "exponent", 
                
                "mantissa"}, {$CellContext`sign$, $CellContext`expsign$, \
$CellContext`exp$, $CellContext`mant$}}, Dividers -> All]}], 16]]], 
      "Specifications" :> {{{$CellContext`decval$$, 1, "base-10 number"}, 
         Dynamic[(-(2 - 2^(-$CellContext`mantbit$$))) 
          2^(2^$CellContext`expbit$$ - 1)], 
         Dynamic[(2 - 2^(-$CellContext`mantbit$$)) 
          2^(2^$CellContext`expbit$$ - 1)], Appearance -> 
         "Labeled"}, {{$CellContext`expbit$$, 1, "bits in exponent"}, 1, 4, 1,
          Appearance -> 
         "Labeled"}, {{$CellContext`mantbit$$, 1, "bits in mantissa"}, 1, 6, 
         1, Appearance -> "Labeled"}}, "Options" :> {ImagePadding -> 60}, 
      "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{355., {114., 119.}},
...
Cell["\<\
This Demonstration shows the conversion of a decimal number (base 10) to a \
   ...
   RowBox[{"\[VeryThinSpace]", 
    RowBox[{
     ...
     "number", " ", "of", " ", "bits", " ", "for", " ", "the", " ", 
      "mantissa"}], " ", "+"}]}], TraditionalForm]], "InlineMath"],
 "\n",
 Cell[BoxData[
  FormBox[
   RowBox[{"\[VeryThinSpace]", 
    RowBox[{
     RowBox[{
     "number", " ", "of", " ", "bits", " ", "for", " ", "the", " ", 
      "exponent"}], " ", "+"}]}], TraditionalForm]], "InlineMath"],
 "\n",
 Cell[BoxData[
  FormBox[
   RowBox[{
    RowBox[{
    "one", " ", "bit", " ", "for", " ", "the", " ", "sign", " ", "of", " ", 
     "the", " ", "number"}], " ", "+"}], TraditionalForm]], "InlineMath"],
 "\n",
 Cell[BoxData[
  FormBox[
   RowBox[{
   "one", " ", "bit", " ", "for", " ", "the", " ", "sign", " ", "of", " ", 
    "the", " ", "exponent"}], TraditionalForm]], "InlineMath"]
}], "DetailNotes",
 CellID->17126032],

Cell["\<\
As an example, how would 54.75 be represented when four bits are used for the \
mantissa and three bits are used for the exponent?\
\>", "DetailNotes",
 CellID->55126145],
...
Cell[TextData[Cell[BoxData[
 FormBox[
  RowBox[{
   SubscriptBox["54.75", "10"], "=", 
   RowBox[{
    SubscriptBox["110110.11", "2"], "=", 
    RowBox[{
     RowBox[{
      SubscriptBox["1.1011011", "2"], "\[Times]", 
      SuperscriptBox["2", "5"]}], "=", 
     RowBox[{
      SubscriptBox["1.1011011", "2"], "\[Times]", 
      SuperscriptBox["2", 
...
Cell["Both the number and the exponent are positive.", "DetailNotes",
 CellID->24186622],

Cell["\<\
As the number is normalized to lie between 1 and 2 (the interval being \
half-closed at the bottom and half-open at the top), the leading binary digit \
is always 1. So we do not actually use it in the representation of the \
mantissa. Hence the mantissa bits are 1011. Moreover the exponent bits are \
101, the sign of the number bit is 0, and the sign of the exponent bit is 0.\
\>", "DetailNotes",
 CellID->1958978293],
 ...
 Cell[BoxData[
  FormBox[
   RowBox[{"\[VeryThinSpace]\[VeryThinSpace]", 
    RowBox[{
    "0", "\[VeryThinSpace]\[VeryThinSpace]\[VeryThinSpace]", "0", "\[VeryThinSpace]\[VeryThinSpace]\[VeryThinSpace]",
      "101", "\[VeryThinSpace]\[VeryThinSpace]\[VeryThinSpace]", "1011"}]}], 
...
Cell[TextData[{
 ButtonBox["Binary",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://mathworld.wolfram.com/Binary.html"], None},
  ButtonNote->"http://mathworld.wolfram.com/Binary.html"],
 " (",
 ButtonBox["Wolfram",
  BaseStyle->"SiteLink",
  ButtonData->{
...
Cell[TextData[{
 ButtonBox["Counting in Binary",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/CountingInBinary/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/CountingInBinary/"],
 " (",
...
Cell[TextData[{
 ButtonBox["Structure of Binary Numbers",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/StructureOfBinaryNumbers/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/StructureOfBinaryNumbers/"],
 " (",
 ButtonBox["Wolfram Demonstrations Project",
  BaseStyle->"SiteLink",
  ButtonData->{
...
DecimalToBinaryFloatingPointConversion&version=0006"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/DecimalToBinaryFloatingPointConversion/\
DecimalToBinaryFloatingPointConversion-source.nb"]], \
...
Cell[TextData[{
 "\"",
 ButtonBox["Decimal to Binary Floating-Point Conversion",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/\
DecimalToBinaryFloatingPointConversion/"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/DecimalToBinaryFloatingPointConversion/\
"],
 "\"",
...
DecimalToBinaryFloatingPointConversion/",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/\
DecimalToBinaryFloatingPointConversion/"], None},
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[41187, 707, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[41448, 716, 3100, 68, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[55243, 1071, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 81940, 1640},
 {"Copyright", 82135, 1645}
 }
*)
(*NotebookFileOutline
Notebook[{
Cell[1292, 31, 34328, 567, 70, "DemonstrationHeader"],
Cell[35623, 600, 64, 0, 70, "DemoTitle"],
Cell[35690, 602, 5348, 98, 70, "Output",
 CellID->1999862340],
Cell[41041, 702, 143, 3, 70, "ManipulateCaption"],
Cell[41187, 707, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[41448, 716, 3100, 68, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[44551, 786, 33, 0, 70, "DetailsSection"],
Cell[44587, 788, 115, 3, 70, "DetailNotes",
 CellID->162858640],
Cell[44705, 793, 898, 30, 70, "DetailNotes",
 CellID->17126032],
Cell[45606, 825, 180, 4, 70, "DetailNotes",
 CellID->55126145],
Cell[45789, 831, 464, 15, 70, "DetailNotes",
 CellID->37918884],
Cell[46256, 848, 88, 1, 70, "DetailNotes",
 CellID->24186622],
Cell[46347, 851, 431, 7, 70, "DetailNotes",
 CellID->1958978293],
Cell[46781, 860, 416, 11, 70, "DetailNotes",
 CellID->177386850],
Cell[47200, 873, 44, 0, 70, "RelatedLinksSection"],
Cell[47247, 875, 610, 21, 70, "RelatedLinks",
 CellID->791725063],
Cell[47860, 898, 476, 14, 70, "RelatedLinks",
 CellID->657291470],
Cell[48339, 914, 500, 14, 70, "RelatedLinks",
 CellID->97291990],
Cell[48842, 930, 4855, 90, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[53700, 1022, 45, 0, 70, "CitationSection"],
Cell[53748, 1024, 912, 26, 70, "Citations"],
Cell[54663, 1052, 577, 17, 70, "Author"],
Cell[55243, 1071, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature ASE2eVHbO6ninvAHaWKuG@KY *)
